        ...
        <div>
            {PROJECTS.map((project, index)=> (
                <div key={index} className='mb-8 flex flex-wrap lg:justify-center'>
                    <motion.div whileInView={{opacity:1, x:1}} initial={{opacity:0, x: -100}} transition={{duration:1}} className='w-full lg:w-1/4'>
                        <img className='mb-6 rounded' width={250} height={250} src={project.image} alt={project.title} />
                    </motion.div>
